  ...
  return (
    <div className={Style.footerContainer}>
         <div className={Style.logoContainer}>
            ...
            <img src={IconSvg} alt="" style={{height:'150px', width : '197px'}} />
            ...
            <img src={InstagramSVG} alt="" style={{height:'40px', width : '40px',marginRight:'12px'}} />
            <img src={GoogleSVG} alt="" style={{height:'40px', width : '40px',marginRight:'12px'}} />
            <img src={FacebookSVG} alt="" style={{height:'40px', width : '40px',marginRight:'12px'}} />
            <img src={YoutubeSVG} alt="" style={{height:'40px', width : '40px',marginRight:'12px'}} />
