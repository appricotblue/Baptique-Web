  ...
  return (
    <div className={Style.baptismContainer}>
      <div className={Style.row}>
        <p className={Style.categoryText}>Similar Products</p>
          ...
          return (
            <div className={Style.cardContainer}>
              <img
                src={val.image}
                alt=""
                style={{ width: "247px", height: "249px" }}
              />
              <p className={Style.categoryName}>{val.name}</p>
              <p className={Style.categoryRate}>{val.rate}</p>
            </div>
          );
        })}
      </div>
